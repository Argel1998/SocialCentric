...
<!DOCTYPE html>
	...
	<link rel="stylesheet" href="styles/website.css" />
		<title>Profile | SocialCentric</title>
	</head>
	<body style= "background-image:url('brownbody.png');">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			<!--background body below cover image-->
			<div style="background-color: whitesmoke;text-align: center;color: rgb(255, 153, 0)">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_profile_image(event)" style="text-decoration: none;color:#FF8C00;" href="change_profile_image.php?change=profile">Change Profile Image</a> | 
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:#FF8C00;" href="change_profile_image.php?change=cover">Change Cover</a>
				...
				<br>
					...
					<div style="font-size: 20px;color: black;">
						<a style="color:black; text-decoration:none; font-size:25px" href="profile.php?id=<?php echo $user_data['userid'] ?>">
							<?php echo $user_data['first_name'] . " " . $user_data['last_name']  ?>
							<!--@username of user below full name displayed-->
							<br><span style="font-size:12px; color:black">@<?=$user_data['tag_name']?></span>
						</a>
						...
						<a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Follow <?php echo $mylikes ?>" style="margin-right:10px;background-color: #FF8C00;width:auto;">
						</a>
